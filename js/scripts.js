var quotes = [
  ...
  "<p>Say I <em>liked</em> it. Say I <em>loved</em> it. Say <em>Thank you for sharing this with me</em>. No, don't say any of that. I'll have no idea if it's true. Say something else.</p><p>-These Imaginary Acts</p>",
